...
#export merged dataset as R object for reproducibility
save(music.df, file = 'music_genre.RData')
...
out.test.redux #FALSE equals swamped value
length(which(out.test.redux == FALSE)) #number of swamped values
